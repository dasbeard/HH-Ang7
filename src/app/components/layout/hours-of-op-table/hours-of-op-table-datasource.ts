...
export interface HoursOfOpTableItem {
  day: string;
  open: string;
  close: string;
}
...
const EXAMPLE_DATA: HoursOfOpTableItem[] = [
...
/**
 * Data source for the HoursOfOpTable view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class HoursOfOpTableDataSource extends DataSource<HoursOfOpTableItem> {
  data: HoursOfOpTableItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<HoursOfOpTableItem[]> {
   ...
   */
  // private getPagedData(data: HoursOfOpTableItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  // private getSortedData(data: HoursOfOpTableItem[]) {
